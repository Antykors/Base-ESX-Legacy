...
Config.Job = "unicorn" -- set nil to not be locked by a job // "job" for locked for a specified job // {['job'] = 2} for a specific grade in a job You can even set {['job1'] = 3, ['job2'] = 4} for mutiple jobs and grades
...
Config.Blip = {
    ...
    Text = "Vanilla Unicorn", -- defines what the blip should be named
}
