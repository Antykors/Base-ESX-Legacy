...
Config.Faction = "vagos" -- set nil to not be locked by a faction // "faction" for locked for a specified faction // {['faction'] = 2} for a specific grade in a faction You can even set {['faction1'] = 3, ['faction2'] = 4} for mutiple factions and grades
...
Config.Blip = {
    ...
    Text = "Quartier Vagos", -- defines what the blip should be named
}
