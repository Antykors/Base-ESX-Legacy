...
function lib.loadLocale()
	local locales = json.decode(LoadResourceFile(cache.resource, ('locales/%s.json'):format(GetConvar('ox:locale', 'fr'))) or LoadResourceFile(cache.resource, 'locales/fr.json') or '[]')
